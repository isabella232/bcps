# WIP-2022-002 : Elision, Redaction, and Noncorrelation in Smart Documents
...
Our reference work in progress is a structure simply called `Envelope` that is currently implemented in Swift as a proof-of-concept architecture. `Envelope` is part of a capability suite called [Secure Components](https://github.com/blockchaincommons/BCSwiftSecureComponents). Documentation for Secure Components and `Envelope` specifically can be found [here](https://github.com/BlockchainCommons/Gordian/tree/master/Envelope).
...
The reader is referred to the [Secure Components documentation](https://github.com/BlockchainCommons/Gordian/tree/master/Envelope) for a discussion of the specific cryptographic algorithms that `Envelope` uses.
...
The reader is referred to the [Secure Components documentation on elision](https://github.com/BlockchainCommons/Gordian/blob/master/Envelope/Elision.md) for fully-worked examples.
...
Also see our [Envelope docs](https://github.com/BlockchainCommons/Gordian/tree/master/Envelope), especially the sections on [Noncorrelation](https://github.com/BlockchainCommons/Gordian/blob/master/Envelope/Noncorrelation.md) and [Elision and redaction](https://github.com/BlockchainCommons/Gordian/blob/master/Envelope/Elision.md).
